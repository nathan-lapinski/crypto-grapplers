...
export interface GrapplerFactoryInterface extends utils.Interface {
  ...
  decodeFunctionResult(functionFragment: "grapplers", data: BytesLike): Result;
...
export interface GrapplerFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GrapplerFactoryInterface;
